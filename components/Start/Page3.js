...
export default function Page3({ScreenHeight, ScreenWidth,Position,index}){
    return(
        <>
        <View style={[
            styles.page,
            ...
            <Image source={mainImage3} style={[styles.image,{width: ScreenWidth * 0.8 ,marginTop: ScreenHeight * 0.1079}]}></Image>
